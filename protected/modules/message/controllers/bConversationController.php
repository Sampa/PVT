...
class ConversationController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if (isset($_POST['Conversation'])) {
            ...
            $model->recruiterId= user()->id;
            $model->publisherIdId= $id;
			if ($model->save()) {
	...
	public function actionIndex()
	{
        ...
        if($user->recruiter){
            $c->compare("recruiterId",$user->id);
        }
		$dataProvider=new CActiveDataProvider('Conversation',array("criteria"=>$c));
	 ...
	 * @param Conversation $model the model to be validated
	 */
