<tr class="accordion-heading">
	...
	<td class=" accordion-heading" href="#sent<?= $index; ?>">
		<a href="<?=$this->createUrl("view/",array("id"=>$message->sender_id));?>"><?php echo $message->getSenderName();?></a>
	</td>
	<td class="clickable accordion-heading accordion-toggle" data-toggle="collapse" href="#sent<?= $index; ?>">
...
<tr>
	<td colspan="5">
		<div id="sent<?= $index; ?>" class="accordion-body collapse" style="padding:0px;">
