...
<div class="row col-md-12 col-lg-12">
	...
	<div class="col-md-9 col-lg-9">
		...
		<table class="dataGrid">
			...
			<?php foreach ($messagesAdapter->data as $index => $message): ?>
				<tr>
					...
					<td><span
							class="date"><?php echo date(Yii::app()->getModule('message')->dateFormat, strtotime($message->created_at)) ?></span>
					</td>
				</tr>
			<?php endforeach ?>
		</table>
		...
		<div class="row buttons">
			<?php echo CHtml::submitButton(t("Radera markerade"), array("class" => "btn btn-danger")); ?>
		</div>
		<?php $this->endWidget(); ?>
	</div>
</div>
