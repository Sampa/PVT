    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" id="reportModalStartFooter">
                ...
                <button type="button" class="btn btn-primary" data-id="" data-url="<?php echo yii::app()->baseUrl;?>/reportedCv/create" id="submitReportBtn"><?php echo Yii::t("t", "Rapportera CV");?></button>
            </div>
