...
class VideoController extends Controller
{
	...
	{
		if(isset($_POST['Video']['id']) && $_POST['Video']['id'] !=="" ){
        	$id = $_POST['Video']['id'];	
        }elseif(isset($_GET['Video']['id']) && $_GET['Video']['id'] !=="" ){
        	$id = $_GET['Video']['id'];
        }		$model=new Video;
        ...
        if(isset($id)){
			...
			$this->performAjaxValidation($model, "video");
    	}else{
    		$model = new Video;
    	}
	...
	*/
	...
	public function getLink($model){
		return CHtml::link($model->title,'/video/view/id/'.$model->id,array());
	}
