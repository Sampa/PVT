        ...
        <div class="row">
            <div class="col-md-8 col-md-6 col-md-8">
                ...
                <p id="texts"><?php echo Yii::t("t","För att kunna skapa och lägga upp CV:n måste du först vara registrerad som publicerare. 
                    För att lägga upp ett CV klickar du på 'Skapa nytt CV'. Här väljer du vilken typ av anställning du är intresserad av.
...
<div class="row">
    ...
    <div class="row">
        ...
        till en rekryteringsprocess. Genom att trycka på knappen lägg till i hotlist, får du välja att skapa en ny process eller lägga till CV i en process som redan finns genom att klicka på namnet
