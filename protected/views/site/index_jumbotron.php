    ...
    <div class="row">
        <div class="container">
            ...
            <div  class='col-md-6' align='right'>
                ...
                <p><?php echo Yii::t("t", "Användarnamnet man registrerar är det som visas tillsammans med ditt publicerade CV. Detta innebär att du kan ha ett namn som inte är kopplat till ens person och på så sätt vara anonym. Det är bara CV-Pages som kommer ha ditt riktiga namn och mailadress registrerat. Du får ta eget ansvar för innehållet i CV:et som ska publiceras då vi inte redigerar eller ändrar det i någon form.");?> <br><br> </p>
            </div>
        </div>
        <br>
